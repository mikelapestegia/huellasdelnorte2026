...
export default function InstallPrompt() {
    ...
    return (
        <div className="fixed bottom-20 left-4 right-4 z-50 animate-in slide-in-from-bottom-5 duration-500">
            <div className="bg-slate-900/90 backdrop-blur-xl border border-emerald-500/30 rounded-2xl p-4 shadow-2xl relative">
                <button
                        ...
                        {isIOS ? (
                            <div className="mt-3 flex flex-col gap-2 text-sm text-emerald-400 bg-white/5 p-3 rounded-lg border border-white/5">
                                <div className="flex items-center gap-2">
                                    <span className="bg-slate-800 p-1 rounded"><Share2 className="w-4 h-4" /></span>
                                    <span>Pulsa "Compartir"</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="bg-slate-800 p-1 rounded"><PlusSquare className="w-4 h-4" /></span>
