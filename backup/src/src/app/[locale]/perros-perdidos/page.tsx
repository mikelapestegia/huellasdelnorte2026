...
export default function PerrosPerdidosPage() {
    ...
    if (isSubmitted) {
        return (
            <main className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 py-16">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-400">Protectoras y voluntarios de {form.lostRegion} recibirán la alerta</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-400">Publicación automática en Instagram, Facebook y Twitter</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-400">Alerta a grupos de voluntarios de la zona</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    return (
        <main className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
                    ...
                    <div className="text-center max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-wrap justify-center gap-4 mb-8">
                            <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full border border-white/10">
                                <Mail className="w-4 h-4 text-blue-400" />
                                <span className="text-sm text-slate-300">Email automático</span>
                            </div>
                            <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full border border-white/10">
            ...
            <section className="max-w-3xl mx-auto px-4 pb-16">
                ...
                {/* Step Labels */}
                <div className="flex justify-between text-xs text-slate-400 mb-8 px-4">
                            ...
                            <div className="space-y-6 animate-in fade-in">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-all ${errors.dogName ? "border-red-500" : "border-white/10"
                                                }`}
                                        />
                                        {errors.dogName && (
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-all ${errors.breed ? "border-red-500" : "border-white/10"
                                                }`}
                                        />
                                        {errors.breed && (
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-all ${errors.color ? "border-red-500" : "border-white/10"
                                                }`}
                                        />
                                        {errors.color && (
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value="desconocido" className="bg-slate-800">No lo sé</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        />
                                        <label htmlFor="hasChip" className="text-slate-300">
                                    ...
                                    {form.hasChip && (
                                        <div>
                                            <input
                                                ...
                                                className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-all ${errors.chipNumber ? "border-red-500" : "border-white/10"
                                                    }`}
                                            />
                                            {errors.chipNumber && (
                                    ...
                                    <div className="flex items-center gap-3">
                                        <input
                                            ...
                                            className="w-5 h-5 rounded bg-white/5 border-white/20 text-amber-500 focus:ring-amber-500/50"
                                        />
                                        <label htmlFor="hasCollar" className="text-slate-300">
                                            Llevaba collar
                                        </label>
                                    </div>
                            ...
                            <div className="space-y-6 animate-in fade-in">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-all ${errors.lostLocation ? "border-red-500" : "border-white/10"
                                            }`}
                                    />
                                    {errors.lostLocation && (
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-all ${errors.lostCity ? "border-red-500" : "border-white/10"
                                                }`}
                                        />
                                        {errors.lostCity && (
                            ...
                            <div className="space-y-6 animate-in fade-in">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-all ${errors.ownerName ? "border-red-500" : "border-white/10"
                                            }`}
                                    />
                                    {errors.ownerName && (
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-all ${errors.ownerPhone ? "border-red-500" : "border-white/10"
                                            }`}
                                    />
                                    {errors.ownerPhone && (
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-all ${errors.ownerEmail ? "border-red-500" : "border-white/10"
                                            }`}
                                    />
                                    {errors.ownerEmail && (
                                ...
                                <div className="flex items-center gap-3">
                                    <input
                                        ...
                                        className="w-5 h-5 rounded bg-white/5 border-white/20 text-amber-500 focus:ring-amber-500/50"
                                    />
                                    <label htmlFor="allowWhatsApp" className="text-slate-300">
                                ...
                                <div className="bg-white/5 rounded-2xl p-6 mt-8">
                                    ...
                                    <div className="space-y-3 text-sm">
                                        <div className="flex justify-between">
                                            <span className="text-slate-400">Perro:</span>
                                            <span className="text-white font-medium">{form.dogName} ({form.breed})</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-slate-400">Color/Tamaño:</span>
                                            <span className="text-white">{form.color} / {sizeLabels[form.size]}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-slate-400">Desaparecido:</span>
