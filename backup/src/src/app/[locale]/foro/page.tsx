    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-emerald-500/30">
            ...
            <div className="relative pt-32 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-emerald-900/20 to-slate-950 pointer-events-none" />
                ...
                <div className="relative max-w-7xl mx-auto text-center">
                    ...
                    <div className="max-w-xl mx-auto relative group">
                        ...
                        <div className="relative bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-2xl p-2 flex items-center shadow-2xl">
                            <Search className="w-5 h-5 text-slate-400 ml-3 mr-3" />
                            <input
                                type="text"
                                placeholder="Buscar temas, consejos, razas..."
                                className="bg-transparent border-none outline-none text-white placeholder-slate-500 flex-1 h-10"
                                value={searchQuery}
                            ...
                            {searchQuery && (
                                <button
                                    ...
                                    className="mr-2 p-2 rounded-full text-slate-400 hover:text-white hover:bg-white/10 transition-colors"
                                >
                                    <X className="w-4 h-4" />
                                </button>
                            )}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-slate-900/50 backdrop-blur-md rounded-2xl p-5 border border-white/5 sticky top-24">
                        ...
                        <div className="bg-transparent p-5 rounded-2xl border border-white/5 hidden lg:block">
                            <h4 className="text-xs uppercase tracking-widest text-slate-500 font-bold mb-4">Estadísticas</h4>
                    ...
                    <div className="lg:col-span-3 space-y-4">
                        <div className="flex items-center justify-between mb-4 px-2">
                            ...
                            <div className="flex gap-2">
                                <select className="bg-slate-900 border border-white/10 text-slate-300 text-sm rounded-lg px-3 py-1.5 focus:outline-none focus:border-emerald-500">
                        ...
                        <div className="mb-4 px-2 flex flex-wrap items-center gap-2 text-xs text-slate-500">
                        ...
                        {filteredPosts.length === 0 ? (
                            ...
                            filteredPosts.map((post) => (
                                <div
                                    key={post.id}
                                    className="group relative bg-slate-900/50 hover:bg-slate-900/80 backdrop-blur-sm border border-white/5 hover:border-emerald-500/30 rounded-2xl p-5 transition-all duration-300 hover:shadow-xl hover:shadow-black/20"
                                >
                                    {post.isPinned && (
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <div className="flex-shrink-0">
                                            <img
                                                ...
                                                className="w-12 h-12 rounded-full object-cover border-2 border-slate-800 group-hover:border-emerald-500/50 transition-colors"
                                            />
                                        </div>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2 mb-1">
                                                <span className="font-medium text-slate-200 text-sm">{post.author.name}</span>
                                            ...
                                            <div className="flex items-center justify-between border-t border-white/5 pt-3 mt-2">
                                                <div className="flex gap-2">
                                                    {post.tags.map(tag => (
                                                        <span key={tag} className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-slate-800 text-slate-400 group-hover:bg-slate-800/80 transition-colors">
                                                            #{tag}
                                                        </span>
                                                    ))}
                                                </div>
