...
const dangerTypes: Record<DangerType, { label: string; icon: string; color: string }> = {
    ...
    otro: { label: "Otro peligro", icon: "⚠️", color: "bg-slate-500/20 text-slate-300 border-slate-500/30" },
};
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-400">Usuarios cercanos recibirán notificación push</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-400">Difusión en grupos de WhatsApp y Telegram de {form.city}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-400">Nuestro equipo verificará la alerta lo antes posible</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-6 animate-in fade-in">
                                ...
                                <div className="grid sm:grid-cols-2 gap-3">
                                    {Object.entries(dangerTypes).map(([key, { label, icon, color }]) => (
                                        ...
                                        >
                                            ...
                                            <span className={form.dangerType === key ? "text-white font-medium" : "text-slate-300"}>
                                                {label}
                                            </span>
                                        </button>
                                    ))}
                                ...
                                {form.dangerType === "otro" && (
                                    <div className="mt-4">
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-red-500/50 transition-all ${errors.otherDescription ? "border-red-500" : "border-white/10"
                                                }`}
                                        />
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="space-y-3">
                                        {Object.entries(severityLevels).map(([key, { label, description, color }]) => (
                                            ...
                                            >
                                                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center mt-0.5 ${form.severity === key ? "border-current" : "border-slate-500"
                                                    }`}>
                                                    {form.severity === key && (
                                                ...
                                                <div>
                                                    <p className={form.severity === key ? "text-white font-medium" : "text-slate-300"}>
                                                        {label}
                                                    </p>
                                ...
                                <div className="space-y-4 mt-6">
                                    <div className="flex items-center gap-3">
                                        ...
                                        />
                                        <label htmlFor="animalAffected" className="text-slate-300">
                                    ...
                                    {form.animalAffected && (
                                        <div className="pl-8">
                                            <input
                                                ...
                                                maxLength={160}
                                                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-red-500/50 transition-all"
                                            />
                                        </div>
                                    )}
                                </div>
                            ...
                            <div className="space-y-6 animate-in fade-in">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-all ${errors.location ? "border-red-500" : "border-white/10"
                                            }`}
                                    />
                                    {errors.location && (
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-all ${errors.city ? "border-red-500" : "border-white/10"
                                                }`}
                                        />
                                        {errors.city && (
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        />
                                        <label htmlFor="authoritiesNotified" className="text-slate-300">
                                    ...
                                    {form.authoritiesNotified && (
                                        <div className="pl-8">
                                            <input
                                                ...
                                                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all"
                                            />
                                        </div>
                                    )}
                                </div>
                                    ...
                                    <>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all ${errors.reporterEmail ? "border-red-500" : "border-white/10"
                                                    }`}
                                            />
                                        ...
                                        <div className="flex items-center gap-3">
                                            <input
                                                ...
                                                className="w-5 h-5 rounded bg-white/5 border-white/20 text-blue-500 focus:ring-blue-500/50"
                                            />
                                            <label htmlFor="allowContact" className="text-slate-300">
                                ...
                                <div className="bg-white/5 rounded-2xl p-6 mt-8">
                                    ...
                                    <div className="space-y-3 text-sm">
                                        <div className="flex justify-between">
                                            <span className="text-slate-400">Tipo de peligro:</span>
                                        ...
                                        <div className="flex justify-between">
                                            <span className="text-slate-400">Fotos adjuntas:</span>
                                            <span className="text-white">{form.photos.length}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-slate-400">Denuncia:</span>
