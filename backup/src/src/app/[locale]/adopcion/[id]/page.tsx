...
export default function DogDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <main className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 pb-16">
            {/* Header / Breadcrumb */}
            <div className="bg-slate-900/50 backdrop-blur-md border-b border-white/10 sticky top-16 z-20">
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-4">
                        <div className="relative aspect-[4/3] rounded-3xl overflow-hidden bg-slate-800 border border-white/10">
                            {dog.photos.length > 0 ? (
                                <Image
                    ...
                    <div className="space-y-8">
                        ...
                        <div>
                            ...
                            <p className="text-xl text-slate-300">
                                {dog.breed} {dog.mixedBreed && <span className="text-slate-500 text-lg">(Mestizo)</span>}
                            </p>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            <div className="bg-white/5 rounded-xl p-3 border border-white/10">
                                <div className="text-slate-400 text-xs mb-1">Edad</div>
                                <div className="text-white font-medium">{ageDisplay}</div>
                            </div>
                            <div className="bg-white/5 rounded-xl p-3 border border-white/10">
                                <div className="text-slate-400 text-xs mb-1">Tamaño</div>
                                <div className="text-white font-medium">{sizeLabels[dog.size]}</div>
                            </div>
                            <div className="bg-white/5 rounded-xl p-3 border border-white/10">
                                <div className="text-slate-400 text-xs mb-1">Peso</div>
                                <div className="text-white font-medium">{dog.weight ? `${dog.weight}kg` : "No indicado"}</div>
                            </div>
                            <div className="bg-white/5 rounded-xl p-3 border border-white/10">
                                <div className="text-slate-400 text-xs mb-1">Etapa</div>
                        ...
                        <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                            ...
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-400">{dog.shelterCity}, {dog.shelterRegion}</p>
