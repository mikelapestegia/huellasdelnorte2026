...
export default function CreatorsPage() {
    ...
    const getCategoryBadge = (category: string) => {
        ...
        return (
            <span className={`px-2 py-1 rounded-md text-xs font-medium border ${colors[category] || 'bg-slate-800 text-slate-400'}`}>
                {category}
            </span>
        );
    };
    ...
    return (
        <main className="min-h-screen bg-slate-950 text-slate-200">
            ...
            <div className="relative pt-32 pb-12 px-4 text-center overflow-hidden">
                ...
                <p className="text-slate-400 max-w-2xl mx-auto mb-8 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
                ...
                <div className="max-w-md mx-auto relative group animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                    <input
                        ...
                        className="w-full bg-slate-900/80 backdrop-blur-md border border-white/10 rounded-xl py-3 pl-12 pr-10 text-white focus:ring-2 focus:ring-indigo-500 outline-none transition-all shadow-lg"
                    />
                    ...
                    {searchQuery && (
                        <button
                            ...
                            className="absolute right-3 top-3 p-1 rounded-full text-slate-400 hover:text-white hover:bg-white/10 transition-colors"
                        >
                            <X className="w-4 h-4" />
                        </button>
                    )}
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
                <div className="bg-slate-900/40 backdrop-blur-xl border border-white/5 rounded-2xl overflow-hidden shadow-2xl animate-fade-in-up" style={{ animationDelay: '300ms' }}>
                    <div className="flex flex-wrap items-center justify-between gap-2 px-4 py-3 border-b border-white/5 text-xs text-slate-500">
                            ...
                            >
                                ...
                                <div className="col-span-4 md:col-span-3 flex items-center gap-3">
                                    <div className="relative">
                                        ...
                                        />
                                        {creator.featured && (
                                            <div className="absolute -top-1 -right-1 bg-amber-400 text-slate-900 p-0.5 rounded-full" title="Destacado">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 md:hidden">{creator.category}</p>
                                ...
                                {/* Platform (Desktop) */}
                                <div className="col-span-3 md:col-span-2 hidden md:flex items-center gap-2 text-sm text-slate-300">
                                    {getPlatformIcon(creator.platform)}
                                    <span>{creator.platform}</span>
                                </div>

                                {/* Description */}
                                <div className="col-span-7 md:col-span-4 text-sm text-slate-400 line-clamp-2 md:line-clamp-1 pr-4">
                                    {creator.description}
                                </div>
                                ...
                                <div className="col-span-1 flex justify-end">
                                    <a
                                        ...
                                        className="p-2 rounded-lg bg-white/5 hover:bg-indigo-500 hover:text-white text-slate-400 transition-all transform hover:scale-110"
