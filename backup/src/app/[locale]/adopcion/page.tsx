        ...
        <div className="group relative bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden hover:border-emerald-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/10 flex flex-col h-full">
            ...
            <div className="p-5 flex flex-col flex-grow">
                ...
                <div className="flex items-center gap-3 mb-4">
                    <span className="flex items-center gap-1.5 px-2 py-1 bg-white/5 rounded-lg text-xs text-slate-300">
                        <Scale className="w-3 h-3" />
                        {sizeConfig[dog.size].label}
                    </span>
                    {dog.weight && (
                        <span className="text-xs text-slate-400">{dog.weight}kg</span>
                    )}
                </div>
                ...
                <div className="flex flex-wrap gap-1.5 mb-4">
                    {dog.personality.slice(0, 3).map((trait) => (
                        <span key={trait} className="px-2 py-0.5 bg-white/5 text-slate-400 rounded-full text-xs">
                            {trait}
                        </span>
                    ))}
                </div>
                ...
                <div className="pt-4 border-t border-white/10 mt-auto">
                    <div className="flex items-center justify-between gap-3 mb-3">
                        <p className="text-xs text-slate-500 truncate">{dog.shelterName}</p>
...
export default function AdopcionPage() {
    ...
    return (
        <main className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
                    ...
                    <div className="text-center max-w-3xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                                ...
                                <p className="text-sm text-slate-400">Perros disponibles</p>
                            </div>
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                                <p className="text-2xl font-bold text-red-400">{stats.urgent}</p>
                                <p className="text-sm text-slate-400">Casos urgentes</p>
                            </div>
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                                <p className="text-2xl font-bold text-pink-400">{stats.puppies}</p>
                                <p className="text-sm text-slate-400">Cachorros</p>
                            </div>
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                                <p className="text-2xl font-bold text-amber-400">{stats.seniors}</p>
                                <p className="text-sm text-slate-400">Seniors</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* Search and Filters */}
            <section className="sticky top-16 z-30 bg-slate-900/95 backdrop-blur-md border-b border-white/10">
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                        ...
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500/50 transition-all"
                            />
                        </div>
                        ...
                        <div className="relative">
                            ...
                            >
                                {ages.map((age) => (
                                    <option key={age.id} value={age.id} className="bg-slate-800">
                                        {age.label}
                                    </option>
                                ))}
                            </select>
                        ...
                        {hasActiveFilters && (
                            <button
                                ...
                                className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-white/10 text-slate-300 hover:bg-white/10"
                            >
                                <X className="w-5 h-5" />
                ...
                {sortedDogs.length > 0 ? (
                    ...
                    <div className="text-center py-16">
                        <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mx-auto mb-4">
                            <Dog className="w-8 h-8 text-slate-500" />
                        </div>
            ...
            <section className="max-w-7xl mx-auto px-4 pb-16">
                <div className="bg-gradient-to-br from-pink-900/30 via-slate-800/50 to-emerald-900/30 rounded-3xl p-8 md:p-12 border border-white/10">
            ...
            <section className="max-w-7xl mx-auto px-4 pb-16">
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gradient-to-br from-amber-900/30 to-slate-900/50 rounded-2xl p-6 border border-amber-500/20">
                        <h3 className="text-xl font-bold text-white mb-3">
                            ¿No puedes adoptar?
                        </h3>
                        <p className="text-slate-300 mb-4">
