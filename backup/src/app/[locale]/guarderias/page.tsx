            ...
            <div className="p-6">
                ...
                <div className="flex flex-wrap gap-1.5">
                    {kennel.services.slice(0, 5).map((service) => (
                        <span
                            key={service}
                            className="inline-flex items-center gap-1 px-2 py-1 bg-white/5 text-slate-400 rounded-lg text-xs"
                    ...
                    {kennel.services.length > 5 && (
                        <span className="inline-flex items-center px-2 py-1 bg-white/5 text-slate-500 rounded-lg text-xs">
                            +{kennel.services.length - 5}
                        </span>
                    )}
                </div>
                    ...
                    <div className="text-center max-w-3xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                                ...
                                <p className="text-sm text-slate-400">Establecimientos</p>
                            </div>
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                            ...
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                                ...
                                <p className="text-sm text-slate-400">Hoteles</p>
                            </div>
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                                <p className="text-2xl font-bold text-blue-400">{stats.guarderias}</p>
                                <p className="text-sm text-slate-400">Guarderías</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-4">
                        ...
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-10 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all"
                            />
                            {searchQuery && (
                                <button
                                    type="button"
                ...
                <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-3xl p-8 border border-slate-700/50">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {Object.entries(stats.byRegion).map(([region, count]) => (
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <MapPin className={`w-5 h-5 ${selectedRegion === region ? "text-emerald-400" : "text-slate-400"}`} />
                                    <span className={selectedRegion === region ? "text-white font-medium" : "text-slate-300"}>
                                        {region}
                                    </span>
                                </div>
