...
export default function MapLayers() {
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[320px_1fr] gap-8">
      <aside className="rounded-2xl border border-border bg-white/80 p-6 shadow-lg">
          ...
          {configs.map((layer) => {
            ...
            return (
              <button
                ...
                className={`w-full rounded-xl border px-4 py-3 text-left transition ${isActive ? "border-primary bg-primary/10" : "border-border bg-white"
                  }`}
              >
