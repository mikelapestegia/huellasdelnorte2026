...
import aragonBreedsData from '@/data/aragon_breeds.json';
...
const AragonBreedsSection = () => {
  const [breeds, setBreeds] = useState<BreedInfo[]>([]);

  useEffect(() => {
    // In a real app, we would fetch from an API
    // For now, we'll use the static data
    setBreeds(aragonBreedsData.aragon_breeds as BreedInfo[]);
  }, []);

  return (
    <section className="aragon-breeds-section">
      <h2>Razas Autóctonas de Aragón</h2>
      <p>Descubre las razas de perros originarias de Aragón, adaptadas a las condiciones climáticas y geográficas de la región pirenaica.</p>
      ...
      <div className="breed-info-sources">
        ...
        <ul>
          {aragonBreedsData.breed_info_sources?.map((source, idx) => (
            <li key={idx}>
...
export default AragonBreedsSection;