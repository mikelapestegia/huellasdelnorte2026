...
import assistanceData from '@/data/galician_assistance_programs.json';
...
const GalicianAssistanceDogsSection = () => {
  const [programs, setPrograms] = useState<AssistanceProgram[]>([]);

  useEffect(() => {
    setPrograms(assistanceData.galician_assistance_programs as AssistanceProgram[]);
  }, []);

  return (
    <section className="galician-assistance-dogs-section">
      <h2>Perros de Asistencia en Galicia</h2>
      <p>Información sobre los programas de perros guía, de asistencia y de terapia disponibles en Galicia.</p>
      ...
      <div className="regulatory-framework">
        ...
        <p>Los perros de asistencia en Galicia se rigen por:</p>
        <ul>
          <li><strong>Ley 10/2003:</strong> De 26 de diciembre, de Accesibilidad y Supresión de Barreras Arquitectónicas, Urbanísticas y de Transporte en Galicia</li>
          <li><strong>Decreto 90/2002:</strong> De 28 de febrero, por el que se regula la tenencia de animales potencialmente peligrosos en la Comunidad Autónoma de Galicia</li>
          <li><strong>Registro:</strong> De perros de asistencia de la Xunta de Galicia</li>
        </ul>
      ...
      <style jsx>{`
        .galician-assistance-dogs-section {
          padding: 2rem 0;
          max-width: 1200px;
          margin: 0 auto;
        }
...
export default GalicianAssistanceDogsSection;