...
import galicianBreedsData from '@/data/galician_breeds.json';
...
const GalicianBreedsSection = () => {
  const [breeds, setBreeds] = useState<BreedInfo[]>([]);

  useEffect(() => {
    // In a real app, we would fetch from an API
    // For now, we'll use the static data
    setBreeds(galicianBreedsData.galician_breeds as BreedInfo[]);
  }, []);

  return (
    <section className="galician-breeds-section">
      <h2>Razas Autóctonas de Galicia</h2>
      <p>Descubre las razas de perros originarias de Galicia, adaptadas a las condiciones climáticas y geográficas de la región.</p>
      ...
      <div className="breed-info-sources">
        ...
        <ul>
          {galicianBreedsData.breed_info_sources?.map((source, idx) => (
            <li key={idx}>
...
export default GalicianBreedsSection;