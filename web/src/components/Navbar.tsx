...
import {
    ...
    Film, Headphones, LogOut, User as UserIcon, Calendar, ShoppingCart, FileText
} from "lucide-react";
...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-lg border-b border-white/5">
            <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link href="/" className="flex items-center gap-2 group flex-shrink-0">
                        <div className="h-10 w-10 bg-gradient-to-br from-emerald-500/20 to-emerald-900/40 rounded-xl flex items-center justify-center transition-transform group-hover:scale-105 shadow-lg shadow-emerald-500/10 border border-emerald-500/20 backdrop-blur-sm overflow-hidden p-1">
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                        ...
                        <button
                            ...
                            className="xl:hidden p-2 rounded-lg text-muted-foreground hover:text-white hover:bg-white/5 transition-colors"
            ...
            {/* Mobile Navigation */}
            {isOpen && (
                <div className="xl:hidden bg-background border-b border-white/5 animate-fade-in max-h-[80vh] overflow-y-auto">
