...
export default function AssistanceCentersPanel() {
  ...
  return (
    <div className="rounded-2xl border border-border bg-card/90 p-8 shadow-xl">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-border bg-card px-9 py-2 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40"
            />
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {filtered.map((center) => (
          <div key={center.name} className="rounded-2xl border border-border bg-card p-5 shadow-sm">
