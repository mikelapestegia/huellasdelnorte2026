                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    ...
                    <div className="flex justify-center gap-4 animate-fade-in-up delay-300">
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-full font-bold transition-all ${activeTab === 'all' ? 'bg-card text-foreground shadow-lg shadow-black/20' : 'bg-card/80 text-muted-foreground hover:text-white'}`}
                        >
                            Todo
                        </button>
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-full font-bold transition-all flex items-center gap-2 ${activeTab === 'tech' ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-900/50' : 'bg-card/80 text-muted-foreground hover:text-white'}`}
                        >
                        ...
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-full font-bold transition-all flex items-center gap-2 ${activeTab === 'food' ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-900/50' : 'bg-card/80 text-muted-foreground hover:text-white'}`}
                        >
            ...
            <div className="max-w-7xl mx-auto px-4 py-12 grid lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    {filteredProducts.length > 0 ? (
                        ...
                        <div className="text-center py-16 bg-card/40 rounded-2xl border border-white/5">
                ...
                <div className="space-y-8 sticky top-24 h-fit">
                    ...
                    {(activeTab === 'all' || activeTab === 'tech') && (
                        <div className="bg-card rounded-2xl p-6 border border-indigo-500/20 shadow-xl shadow-indigo-900/10">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">¿Cuánto vale su tranquilidad?</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full accent-indigo-500 h-2 bg-card/70 rounded-lg appearance-none cursor-pointer"
                                    />
                                ...
                                <div className="p-4 bg-background rounded-xl border border-white/5 space-y-2">
                                    <div className="flex justify-between items-center">
                                        <span className="text-sm text-muted-foreground">Coste GPS diario:</span>
                                        <span className="text-emerald-400 font-bold">0.16€</span>
                                    </div>
                                    <div className="flex justify-between items-center pt-2 border-t border-white/5">
                                        <span className="text-sm text-muted-foreground">Ahorro en sustos:</span>
                    ...
                    {(activeTab === 'all' || activeTab === 'food') && (
                        <div className="bg-gradient-to-br from-emerald-900/40 to-card rounded-2xl p-6 border border-emerald-500/20">
                            ...
                            <div className="flex -space-x-3 mb-4 pl-3">
                                {[1, 2, 3].map(i => (
                                    <div key={i} className="w-8 h-8 rounded-full bg-card/70 border-2 border-border flex items-center justify-center text-xs font-bold text-white">
                                        {i === 3 ? '+20' : ''}
                                    </div>
                                ))}
                            </div>
