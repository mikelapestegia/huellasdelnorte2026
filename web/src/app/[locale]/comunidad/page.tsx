...
export default function ComunidadPage() {
    ...
    return (
        <main className="min-h-screen bg-gradient-to-b from-card via-card/80 to-card">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
                    <div className="text-center">
                        ...
                        <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-10">
                            ...
                            y eventos caninos en toda la región del norte peninsular y sur de Francia.
                        </p>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                                ...
                                <div className="text-sm text-muted-foreground">Protectoras</div>
                            </div>
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                                <div className="text-3xl font-bold text-amber-400">{stats.plataformasPerdidos}</div>
                                <div className="text-sm text-muted-foreground">Plat. Perdidos</div>
                            </div>
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                            ...
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                                ...
                                <div className="text-sm text-muted-foreground">Euskal Herria</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* Search and Filters */}
            <section className="sticky top-0 z-40 bg-card/95 backdrop-blur-md border-b border-white/10">
                    ...
                    {showFilters && (
                        <div id="comunidad-filtros" className="mt-4 p-4 bg-white/5 rounded-xl border border-white/10 animate-in slide-in-from-top-2">
                            <div className="grid md:grid-cols-2 gap-4">
                                {/* Region Filter */}
                                <div>
                                    <label className="block text-sm text-muted-foreground mb-2">Región</label>
