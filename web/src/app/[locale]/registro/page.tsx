...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Error handled silently — user sees submit button re-enabled
        } finally {
    ...
    return (
        <main className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-background">
            ...
            <div className="hidden lg:flex order-2 relative flex-col justify-between p-12 bg-emerald-900/20 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-background via-card/50 to-emerald-900/50" />
                ...
                <div className="relative z-10 max-w-lg ml-auto text-right">
                    ...
                    <ul className="text-muted-foreground space-y-3 inline-block text-left">
                ...
                <div className="relative z-10 text-right text-xs text-muted-foreground font-medium">
                    <span>Sujeto a la Política de Privacidad y Términos de Servicio.</span>
                </div>
            </div>

            {/* Right Side - Form (Order 1) */}
            <div className="flex flex-col justify-center items-center p-6 sm:p-12 lg:p-24 bg-background relative order-1">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    autoComplete="name"
                                    className="w-full pl-10 pr-3 py-3 border border-border rounded-xl bg-card/50 text-white focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 outline-none transition-all"
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-10 py-3 border border-border rounded-xl bg-card/50 text-white focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 outline-none transition-all"
