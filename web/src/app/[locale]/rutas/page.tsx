                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="relative max-w-xl">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-4 rounded-xl bg-card text-foreground placeholder:text-foreground/50 focus:outline-none focus:ring-2 focus:ring-accent shadow-lg"
                        />
                    </div>
                </div>
