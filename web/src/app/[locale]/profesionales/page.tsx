            ...
            <div className="relative pt-32 pb-20 px-4 bg-gradient-to-br from-card via-indigo-950/20 to-background border-b border-white/5 overflow-hidden">
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
                    <div className="text-left space-y-8">
                        ...
                        <p className="text-xl text-muted-foreground max-w-lg leading-relaxed animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
                            ...
                            <button
                                type="button"
                                className="px-8 py-4 rounded-xl bg-card/80 hover:bg-card/70 text-white font-bold border border-border transition-colors"
                    ...
                    <div className="relative hidden lg:block animate-fade-in lg:order-last">
                        ...
                        <div className="relative grid grid-cols-2 gap-4">
                            <div className="space-y-4 translate-y-8">
                                <div className="p-6 bg-card rounded-2xl border border-white/10 shadow-2xl">
                                    <Stethoscope className="w-8 h-8 text-rose-400 mb-4" />
                                    <h3 className="font-bold text-white">Veterinarios</h3>
                                    <p className="text-sm text-muted-foreground">Gestión de citas y perfil sanitario.</p>
                                </div>
                                <div className="p-6 bg-card rounded-2xl border border-white/10 shadow-2xl">
                                    <Store className="w-8 h-8 text-amber-400 mb-4" />
                                    <h3 className="font-bold text-white">Tiendas</h3>
                                    <p className="text-sm text-muted-foreground">Catálogo de productos y ofertas.</p>
                                </div>
                            </div>
                            <div className="space-y-4">
                                <div className="p-6 bg-card rounded-2xl border border-white/10 shadow-2xl">
                                    ...
                                    <p className="text-sm text-muted-foreground">Reservas directas y disponibilidad.</p>
                                </div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={idx} className="p-8 rounded-2xl bg-card border border-white/5 hover:border-emerald-500/20 transition-all hover:bg-card/50">
                                <div className="w-12 h-12 bg-card/80 rounded-xl flex items-center justify-center mb-6">
            ...
            <div className="py-24 bg-card/30 border-y border-white/5">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground">Elige el plan que mejor se adapte a tu etapa actual.</p>
                    </div>

                    <div className="grid lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        {/* Basic Plan */}
                        <div className="p-8 rounded-3xl bg-background border border-white/10 flex flex-col relative overflow-hidden">
                            <div className="mb-4">
                                <h3 className="text-lg font-bold text-muted-foreground">Básico</h3>
                                <div className="flex items-baseline gap-1 mt-2">
                                    <span className="text-4xl font-bold text-white">0€</span>
                                    <span className="text-muted-foreground">/mes</span>
                                </div>
                                <p className="text-sm text-muted-foreground mt-2">Para empezar a tener presencia.</p>
                            </div>
                            ...
                            <button
                                type="button"
                                className="w-full py-3 rounded-xl border border-border text-white font-bold hover:bg-card/80 transition-colors"
                        ...
                        <div className="p-8 rounded-3xl bg-card border border-emerald-500/30 flex flex-col relative overflow-hidden shadow-2xl shadow-emerald-900/20 transform scale-105 z-10">
                            <div className="absolute top-0 right-0 bg-emerald-500 text-background text-xs font-bold px-3 py-1 rounded-bl-xl">
                                RECOMENDADO
                            </div>
                            <div className="mb-4">
                                ...
                                <p className="text-sm text-muted-foreground mt-2">Todo lo necesario para destacar.</p>
                            </div>
                            <ul className="space-y-4 mb-8 flex-1">
                        ...
                        <div className="p-8 rounded-3xl bg-background border border-white/10 flex flex-col relative overflow-hidden">
                            <div className="mb-4">
                                <h3 className="text-lg font-bold text-foreground">Corporate</h3>
                                <div className="flex items-baseline gap-1 mt-2">
                                    <span className="text-2xl font-bold text-white">A medida</span>
                                </div>
                                <p className="text-sm text-muted-foreground mt-2">Para franquicias y múltiples sedes.</p>
                            </div>
                            <ul className="space-y-4 mb-8 flex-1">
                                <li className="flex items-center gap-3 text-muted-foreground text-sm">
                                    <CheckCircle2 className="w-4 h-4 text-muted-foreground flex-shrink-0" /> Gestión multi-sede
                                </li>
                                <li className="flex items-center gap-3 text-muted-foreground text-sm">
                                    <CheckCircle2 className="w-4 h-4 text-muted-foreground flex-shrink-0" /> API de integración
                                </li>
                                <li className="flex items-center gap-3 text-muted-foreground text-sm">
                                    <CheckCircle2 className="w-4 h-4 text-muted-foreground flex-shrink-0" /> Soporte dedicado 24/7
                                </li>
                            </ul>
                            <button
                                type="button"
