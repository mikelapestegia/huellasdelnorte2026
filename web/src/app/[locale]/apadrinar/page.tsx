        ...
        <main className="min-h-screen bg-gradient-to-b from-card via-card/80 to-card pb-16">
            ...
            <section id="casos-urgentes" className="max-w-7xl mx-auto px-4 py-16">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {urgentCases.map((dog) => (
                        <div key={dog.id} className="group relative bg-card/50 rounded-2xl overflow-hidden border border-white/10 hover:border-red-500/30 transition-all">
                            <div className="relative h-48 w-full">
                                {dog.photos[0] ? (
                                    ...
                                    <div className="w-full h-full bg-card/70 flex items-center justify-center">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-sm text-muted-foreground mb-4">{dog.breed}, {dog.age}</p>
            ...
            {/* Plans Section */}
            <section id="planes" className="max-w-7xl mx-auto px-4 py-16 bg-card/50">
                        ...
                        return (
                            <div
                                ...
                                className={`relative flex flex-col p-6 rounded-3xl border transition-all duration-300 ${isSelected
                                        ? "bg-card/80 border-amber-500 scale-105 shadow-xl shadow-amber-500/10 z-10"
