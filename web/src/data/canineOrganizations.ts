...
// =============================================================================
// PROTECTORAS Y REFUGIOS - PENINSULAR
// =============================================================================
...
export const plataformasPerdidos: CanineOrganization[] = [
    {
        ...
        region: "Nacional",
        country: "ES",
        description: "Red oficial nº1 en el territorio desde 2012 para animales perdidos. Difunde alertas via web, Facebook, Twitter, SMS y carteles.",
    ...
    },
    {
        ...
        region: "Nacional",
        country: "ES",
        description: "Portal gratuito dedicado específicamente a perros perdidos y encontrados en el territorio.",
        services: ["busqueda_perdidos"],
...
export const federacionesEventos: CanineOrganization[] = [
    {
        id: "fed-001",
        name: "Real Sociedad Canina (RSCE)",
        type: "federacion",
        region: "Nacional",
        country: "ES",
    ...
    },
    {
        ...
        region: "Nacional",
        country: "ES",
        description: "Organiza y publica calendario de carreras de canicross y mushing en el territorio.",
    ...
    },
    {
        ...
        region: "Nacional",
        country: "ES",
        description: "Plataforma con calendario de eventos de canicross en todo el territorio.",
        services: ["eventos", "canicross"],
...
export const eventosCaninos: CanineEvent[] = [
    ...
    {
        id: "evt-001",
        name: "Copa Nacional de Mushing y Canicross - Buñuel",
        type: "canicross",
        region: "Navarra",
        country: "ES",
        city: "Buñuel",
        description: "Copa Nacional de Mushing y Canicross.",
        date: "2025-11-15",
        website: "https://canicrosscrossmadrid.com",
        isFree: false,
        dogFriendly: true,
